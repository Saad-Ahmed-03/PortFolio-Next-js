...
const skillsData = {
  ...
  API: [
    ...
    { name: 'Shopify GraphQL API\'s', logo: require("../images/GraphQLLogo-White.svg").default },
  ],
  ShopifyTheme: [
    { name: 'Shopify', logo: require("../images/shopify-logo.svg").default },
    { name: 'Liquid Template language', logo: require("../images/Shopify-liquid.webp").default },
    { name: 'JavaScript', logo: require("../images/js-yellow.svg").default },
    { name: 'JQuery', logo: require("../images/jQuery-Logo_On_Dark.svg").default },
  ],
  ShopifyApp: [
