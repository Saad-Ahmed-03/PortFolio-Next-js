    ...
    <Container>
          ...
          <Col lg={2}>
            <CircularProgressbarWithChildren 
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={htmlLogo.src} alt="HTML" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
            <CircularProgressbarWithChildren
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={cssLogo.src} alt="CSS" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
          <CircularProgressbarWithChildren
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={JsLogo.src} alt="Javascript" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
          <CircularProgressbarWithChildren
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={JQueryDarkLogo.src} alt="JQuery" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
          <CircularProgressbarWithChildren
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={ReactLogo1.src} alt="React" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
          <CircularProgressbarWithChildren
              ...
              styles={buildStyles(
                ...
                <img style={{ width: 100, marginTop: -5 }} src={Remixlogo.src} alt="Remix" />
            </CircularProgressbarWithChildren>
          </Col>
      </Row>
      ...
      <Col lg={2}>
            <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={PythonLogo.src} alt="Python" />
            </CircularProgressbarWithChildren>
          </Col>
          <Col lg={2}>
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={ShopifyLogo1.src} alt="Shopify" />
          ...
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={LiquidLogo.src} alt="Liquid" />
          ...
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={MongoDBLogoWhite.src} alt="MongoDB" />
          ...
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={githubCatLogo.src} alt="github" />
          ...
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={vercelLogo.src} alt="vercel" />
          ...
          <CircularProgressbarWithChildren
                ...
                <img style={{ width: 100, marginTop: -5 }} src={PostManLogo.src} alt="PostMan" />
